...
// === Network-first для HTML страниц (Barba) ===
...
// === DatoCMS Cache-first с TTL и fallback ===
async function handleDatoCMSRequest(event) {
  const cloned = event.request.clone();
  const body = await cloned.text();

  // создаём хэш тела GraphQL-запроса
