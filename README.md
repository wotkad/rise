...
Smart Watcher - это умный наблюдатель за изменениями файлов в проекте Rise, который пересобирает только реально изменившиеся файлы, минимизируя время сборки и увеличивая продуктивность разработки.
...
Расширение `friendly-errors-webpack-plugin`, которое скрывает лишние логи из терминала для удобства работы и выводит информацию в более удобном виде.
