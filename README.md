...
- **Webpack**: [https://webpack.js.org](https://webpack.js.org)
  - Сборщик модулей для управления всеми зависимостями сайта (Необходимая версия 5.x или выше).

#### 🛠 Препроцессоры:

- **PUG** [https://pugjs.org](https://pugjs.org) (Это механизм шаблонов и самый быстрый способ написания HTML).
- **SCSS** [https://sass-scss.ru](https://sass-scss.ru) (Это препроцессор CSS, который используется для написания стилей).
