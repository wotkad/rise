...
Шаблон значительно упрощает такие вещи, как сборка проекта, поиск необходимых библиотек для старта проекта, генерацию карты сайта, разработка архитектуры проекта, а также предлагает хранение страниц в формате `.md`. 

**Шаблон включает в себя:**
  - Шаблонизацию в `.pug` и `.scss`
  - Подключения библиотек  `css` и `js`
  - Генерация структуры постов
  - Скрипты для тестов
  - Скрипты для роутинга 
  - Скрипты для проверки внутренних ссылок ссылок
  - и многое другое ...

Для начала работы необходимо установить [главные зависимости](#-главные-зависимости).
